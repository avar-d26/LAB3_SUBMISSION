...
## Switches
## -----------------------------------------------------------------------------------------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 			} [get_ports { ch_select_i[0]		}]; #IO_L19N_T3_VREF_35 		Sch=sw[0]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 			} [get_ports { ch_select_i[1]			}]; #IO_L24P_T3_34 				Sch=sw[1]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 			} [get_ports { enable_fir_i		}]; #IO_L4N_T0_34 				Sch=sw[2]
## TASK 1
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 			} [get_ports { ac_mute_en_i		}]; #IO_L9P_T1_DQS_34 			Sch=sw[3]
## TASK 2
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 			} [get_ports { audio_input_sel_i			}]; #IO_L9P_T1_DQS_34 			Sch=sw[3]
